    ...
    : BaseRow(connectionString, config, handlersGroup, record)
{
    ...
    public int ExpeditionMinPower
    {
        ...
        set
        {
            ...
            using NpgsqlCommand command = connection.CreateCommand();
            command.CommandText =
                "UPDATE common.rarities SET expedition_min_power = @expedition_min_power WHERE id = @id;";
            command.Parameters.Add(new NpgsqlParameter("id", NpgsqlDbType.Uuid) { Value = Id });
    ...
    public TimeSpan ExpeditionMinTime
    {
        ...
        set
        {
            ...
            using NpgsqlCommand command = connection.CreateCommand();
            command.CommandText =
                "UPDATE common.rarities SET expedition_min_time = @expedition_min_time WHERE id = @id;";
            command.Parameters.Add(new NpgsqlParameter("id", NpgsqlDbType.Uuid) { Value = Id });
            command.Parameters.Add(new NpgsqlParameter("expedition_min_time", NpgsqlDbType.Integer)
    ...
    public TimeSpan ExpeditionMaxTime
    {
        ...
        set
        {
            ...
            using NpgsqlCommand command = connection.CreateCommand();
            command.CommandText =
                "UPDATE common.rarities SET expedition_max_time = @expedition_max_time WHERE id = @id;";
            command.Parameters.Add(new NpgsqlParameter("id", NpgsqlDbType.Uuid) { Value = Id });
            command.Parameters.Add(new NpgsqlParameter("expedition_max_time", NpgsqlDbType.Integer)
                { Value = value.TotalMinutes });
    ...
    public int ExpeditionTimeDecreaseBegin
    {
        ...
        set
        {
            ...
            using NpgsqlCommand command = connection.CreateCommand();
            command.CommandText =
                "UPDATE common.rarities SET expedition_tdb = @expedition_time_decrease_begin WHERE id = @id;";
            command.Parameters.Add(new NpgsqlParameter("id", NpgsqlDbType.Uuid) { Value = Id });
            command.Parameters.Add(new NpgsqlParameter("expedition_time_decrease_begin", NpgsqlDbType.Integer)
                { Value = value });
    ...
    public int ExpeditionTimeDecreaseEnd
    {
        ...
        set
        {
            ...
            using NpgsqlCommand command = connection.CreateCommand();
            command.CommandText =
                "UPDATE common.rarities SET expedition_tde = @expedition_time_decrease_end WHERE id = @id;";
            command.Parameters.Add(new NpgsqlParameter("id", NpgsqlDbType.Uuid) { Value = Id });
            command.Parameters.Add(new NpgsqlParameter("expedition_time_decrease_end", NpgsqlDbType.Integer)
                { Value = value });
